...
const config = {
    ...
    BOT_FOOTER: '> 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝐌𝐑 𝐒𝐀𝐇𝐀𝐍 𝐎𝐅𝐂 👨‍💻🇱🇰',
...
async function oneViewmeg(socket, isOwner, msg, sender) {
    if (!isOwner) {
        await socket.sendMessage(sender, {
            text: '❌ *ᴠɪᴇᴡ ᴏɴᴄᴇ ᴍᴇssᴀɢᴇs ᴄᴍᴅ ය හරහා නැරඹිය හැක්කේ බොට් ᴏᴡɴᴇʀ ට පමණි*'
        });
        return;
    }
    try {
...
`;
        const aliveMessage = {
            ...
            caption: `> 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝐌𝐑 𝐒𝐀𝐇𝐀𝐍 𝐎𝐅𝐂 👨‍💻🇱🇰\n\n${captionText}`,
            buttons: [
                {
...
╰──────────────────┈⊷`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '> 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝐌𝐑 𝐒𝐀𝐇𝐀𝐍 𝐎𝐅𝐂 👨‍💻🇱🇰',
                serverMessageId: -1
            }
        };
...
`;
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/2c9ak5.jpg" },
      caption: `*𝐌𝐀𝐒𝐓𝐄𝐑 𝐌𝐃 𝐌𝐈𝐍𝐈*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: 'ᴍᴀꜱᴛᴇʀ ᴍɪɴɪ ᴄᴍᴅ ʟɪꜱᴛ' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴍᴀꜱᴛᴇʀ ᴍɪɴᴊ ᴄᴍᴅ ʟɪꜱᴛ',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'ᴍɪɴɪ ᴍᴀꜱᴛᴇʀ ᴍᴅ',
                  rows: [
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ᴍᴀꜱᴛᴇʀ ᴍᴅ ᴍɪɴɪ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍᴀꜱᴛᴇʀ ᴍᴅ ᴍɪɴɪ
╭─────────────────────⭓
...
*𝙼𝙰𝚂𝚃𝙴𝚁 𝙼𝙳 𝙼𝙸𝙽𝙸 බොට් වෙත ඔබව සාදරයෙන් පිලිගන්නවා ☺️👋*
